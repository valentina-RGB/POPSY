...
const Ventas_Detalles = () => {
  ...
  const status = orderStatus[venta!.ID_estado_venta];
        ...
        <div className="tw-border-b tw-border-gray-200 tw-pb-4 tw-mb-6">
          ...
          <div className="tw-mt-4 tw-flex tw-justify-between tw-text-gray-600 tw-text-sm">
            <div className="tw-flex tw-items-center tw-space-x-2">
              ...
              <span className="tw-text-gray-700">{new Date(venta!.fecha).toLocaleString("es-ES")}</span>
            </div>
            <div className="tw-flex tw-items-center tw-space-x-2">
              <DollarSign className="tw-h-4 tw-w-4 tw-text-gray-400" />
              <span className="tw-font-semibold tw-text-gray-800">{formatPrice(venta!.precio_total)}</span>
            </div>
          </div>
        </div>
